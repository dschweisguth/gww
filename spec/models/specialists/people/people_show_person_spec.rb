describe PeopleShowPerson do
  describe '#mapped_photo_count' do
    ...
    it "ignores unmapped photos" do
      photo = create :people_show_photo
  ...
  describe '#score_standing' do
    let(:person) { create :people_show_person }
    ...
    it "considers other players' scores" do
      create :people_show_guess
      expect(person.score_standing).to eq([2, false])
    end

    it "detects ties" do
      create :people_show_guess, person: person
      create :people_show_guess
  ...
  describe '#posts_standing' do
    ...
    it "considers other players' posts" do
      create :people_show_photo
      expect(person.posts_standing).to eq([2, false])
    end

    it "detects ties" do
      create :people_show_photo, person: person
      create :people_show_photo
  ...
  describe '#first_guess' do
    let(:guesser) { create :people_show_person }

    it "returns the guesser's first guess" do
      create :people_show_guess, person: guesser, commented_at: Time.utc(2001)
      first = create :people_show_guess, person: guesser, commented_at: Time.utc(2000)
  ...
  describe '#most_recent_guess' do
    ...
    it "returns the guesser's most recent guess" do
      create :people_show_guess, person: guesser, commented_at: Time.utc(2000)
      most_recent = create :people_show_guess, person: guesser, commented_at: Time.utc(2001)
  ...
  describe '#first_photo' do
    ...
    it "returns the poster's first post" do
      create :people_show_photo, person: poster, dateadded: Time.utc(2001)
      first = create :people_show_photo, person: poster, dateadded: Time.utc(2000)
  ...
  describe '#most_recent_photo' do
    ...
    it "returns the poster's most recent post" do
      create :people_show_photo, person: poster, dateadded: Time.utc(2000)
      most_recent = create :people_show_photo, person: poster, dateadded: Time.utc(2001)
  ...
  describe '#oldest_guess' do
    ...
    it "returns the guesser's guess made the longest after the post" do
      photo1 = create :people_show_photo, dateadded: Time.utc(2000)
      create :people_show_guess, person: guesser, photo: photo1, commented_at: Time.utc(2001)
      photo2 = create :people_show_photo, dateadded: Time.utc(2002)
      guess2 = create :people_show_guess, person: guesser, photo: photo2, commented_at: Time.utc(2004)
    ...
    it "considers other players' guesses when calculating place" do
      photo1 = create :people_show_photo, dateadded: Time.utc(2000)
      guess1 = create :people_show_guess, person: guesser, photo: photo1, commented_at: Time.utc(2001)
      photo2 = create :people_show_photo, dateadded: Time.utc(2002)
      create :people_show_guess, photo: photo2, commented_at: Time.utc(2004)
      oldest = guesser.oldest_guess
  ...
  describe '#fastest_guess' do
    ...
    it "returns the guesser's guess made the fastest after the post" do
      photo1 = create :people_show_photo, dateadded: Time.utc(2002)
      create :people_show_guess, person: guesser, photo: photo1, commented_at: Time.utc(2004)
      photo2 = create :people_show_photo, dateadded: Time.utc(2000)
      guess2 = create :people_show_guess, person: guesser, photo: photo2, commented_at: Time.utc(2001)
    ...
    it "considers other players' guesses when calculating place" do
      photo1 = create :people_show_photo, dateadded: Time.utc(2002)
      guess1 = create :people_show_guess, person: guesser, photo: photo1, commented_at: Time.utc(2004)
      photo2 = create :people_show_photo, dateadded: Time.utc(2000)
      create :people_show_guess, photo: photo2, commented_at: Time.utc(2001)
      fastest = guesser.fastest_guess
  ...
  describe '#guess_of_longest_lasting_post' do
    ...
    it "returns the poster's photo which went unfound the longest" do
      photo1 = create :people_show_photo, person: poster, dateadded: Time.utc(2000)
      create :people_show_guess, photo: photo1, commented_at: Time.utc(2001)
      photo2 = create :people_show_photo, person: poster, dateadded: Time.utc(2002)
      guess2 = create :people_show_guess, photo: photo2, commented_at: Time.utc(2004)
    ...
    it "ignores guesses of other players' posts" do
      create :people_show_photo, person: poster
      create :people_show_guess
    ...
    it "considers other posters when calculating place" do
      photo1 = create :people_show_photo, person: poster, dateadded: Time.utc(2000)
      guess1 = create :people_show_guess, photo: photo1, commented_at: Time.utc(2001)
      photo2 = create :people_show_photo, dateadded: Time.utc(2002)
      create :people_show_guess, photo: photo2, commented_at: Time.utc(2004)
      longest_lasting = poster.guess_of_longest_lasting_post
  ...
  describe '#guess_of_shortest_lasting_post' do
    ...
    it "returns the guess of the poster's photo which was made the soonest after the post" do
      photo1 = create :people_show_photo, person: poster, dateadded: Time.utc(2002)
      create :people_show_guess, photo: photo1, commented_at: Time.utc(2004)
      photo2 = create :people_show_photo, person: poster, dateadded: Time.utc(2000)
      guess2 = create :people_show_guess, photo: photo2, commented_at: Time.utc(2001)
    ...
    it "considers other posters when calculating place" do
      photo1 = create :people_show_photo, person: poster, dateadded: Time.utc(2002)
      guess1 = create :people_show_guess, photo: photo1, commented_at: Time.utc(2004)
      photo2 = create :people_show_photo, dateadded: Time.utc(2000)
      create :people_show_guess, photo: photo2, commented_at: Time.utc(2001)
      shortest_lasting = poster.guess_of_shortest_lasting_post
  ...
  describe '#oldest_unfound_photo' do
    ...
    it "considers unconfirmed photos" do
      photo = create :people_show_photo, person: poster, game_status: 'unconfirmed'
      expect(poster.oldest_unfound_photo).to eq(photo)
    end

    it "ignores game statuses other than unfound and unconfirmed" do
      create :people_show_photo, person: poster, game_status: 'found'
      expect(poster.oldest_unfound_photo).to be_nil
    end

    it "considers other posters' oldest unfounds when calculating place" do
      create :people_show_photo, person: poster, dateadded: Time.utc(2000)
      next_oldest = create :people_show_photo, dateadded: Time.utc(2001)
    ...
    it "considers unconfirmed photos when calculating place" do
      create :people_show_photo, person: poster, dateadded: Time.utc(2000), game_status: 'unconfirmed'
      next_oldest = create :people_show_photo, dateadded: Time.utc(2001)
      oldest_unfound = next_oldest.person.oldest_unfound_photo
      expect(oldest_unfound).to eq(next_oldest)
      expect(oldest_unfound.place).to eq(2)
  ...
  describe '#most_commented_photo' do
    ...
    it "returns the poster's most-commented photo" do
      create :people_show_photo, person: poster
      first = create :people_show_photo, person: poster, other_user_comments: 1
    ...
    it "counts comments" do
      second = create :people_show_photo, person: poster, other_user_comments: 1
      create :comment, photo: second
      first = create :people_show_photo, person: poster, other_user_comments: 2
      create :comment, photo: first
      create :comment, photo: first
      most_commented = poster.most_commented_photo
      expect(most_commented).to eq(first)
    ...
    it "ignores other posters' photos" do
      photo = create :people_show_photo, other_user_comments: 1
    ...
    it "considers other posters' photos when calculating place" do
      other_posters_photo = create :people_show_photo, other_user_comments: 2
      create :comment, photo: other_posters_photo
      create :comment, photo: other_posters_photo
      photo = create :people_show_photo, person: poster, other_user_comments: 1
      create :comment, photo: photo
    ...
    it "ignores other posters' equally commented photos when calculating place" do
      other_posters_photo = create :people_show_photo, other_user_comments: 1
      create :comment, photo: other_posters_photo
      photo = create :people_show_photo, person: poster, other_user_comments: 1
      create :comment, photo: photo
  ...
  describe '#most_viewed_photo' do
    ...
    it "returns the poster's most-viewed photo" do
      create :people_show_photo, person: poster
      first = create :people_show_photo, person: poster, views: 1
    ...
    it "considers other posters' photos when calculating place" do
      create :people_show_photo, views: 1
      create :people_show_photo, person: poster
  ...
  describe '#most_faved_photo' do
    ...
    it "returns the poster's most-faved photo" do
      create :people_show_photo, person: poster
      first = create :people_show_photo, person: poster, faves: 1
    ...
    it "considers other posters' photos when calculating place" do
      create :people_show_photo, faves: 1
      create :people_show_photo, person: poster
  ...
  describe '#guesses_with_associations' do
    it "returns a person's guesses with their photos and the photos' people" do
      guess = create :people_show_guess
  ...
  describe '#favorite_posters' do
    it "lists the posters which this person has guessed 2.5 or more times as often as this person has guessed all posts" do
      guesser, favorite_poster = make_potential_favorite_poster(:people_show, 10, 15)
    ...
    it "ignores a poster which this person has guessed less than #{Person::MIN_BIAS_FOR_FAVORITE} times as often as this person has guessed all posts" do
      guesser, _favorite_poster = make_potential_favorite_poster(:people_show, 10, 14)
    ...
    it "ignores a poster which this person has guessed less than #{Person::MIN_GUESSES_FOR_FAVORITE} times" do
      guesser, _favorite_poster = make_potential_favorite_poster(:people_show, 9, 15)
      expect(guesser.favorite_posters).to eq([])
    end
  ...
  describe '#favoring_guessers' do
    it "lists the guessers who have guessed this person #{Person::MIN_BIAS_FOR_FAVORITE} or more times as often as those guessers have guessed all posts" do
      devoted_guesser, poster = make_potential_favorite_poster(:people_show, 10, 15)
    ...
    it "ignores a guesser who has guessed this person less than #{Person::MIN_BIAS_FOR_FAVORITE} times as often as that guesser has guessed all posts" do
      _devoted_guesser, poster = make_potential_favorite_poster(:people_show, 10, 14)
    ...
    it "ignores a guesser who has guessed this person less than #{Person::MIN_GUESSES_FOR_FAVORITE} times" do
      _devoted_guesser, poster = make_potential_favorite_poster(:people_show, 9, 15)
      expect(poster.favoring_guessers).to eq([])
    end
