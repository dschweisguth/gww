Feature: Wheresies
  ...
  Scenario: Player views wheresies page
    ...
    And there is a veteran
    And there is a rookie
    And the veteran scored 3 points this year
    And the rookie scored 2 points this year
    And the veteran posted 5 photos this year
    And the rookie posted 4 photos this year
    ...
    And the veteran should be first on the veterans' most-posts list with 5 posts
