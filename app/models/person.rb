class Person < ActiveRecord::Base
  extend PersonScoreSupport # TODO Dave move down to PeoplePerson
  include PersonIndexSupport, PersonPhotosSupport, PersonShowSupport, PersonPeopleSupport, PersonStatisticsSupport
