...
class FlickrService
  ...
  SECRET = ENV.fetch('FLICKR_SECRET')
  OAUTH_CONSUMER_KEY = ENV.fetch('FLICKR_API_KEY')
  OAUTH_TOKEN = ENV.fetch('FLICKR_OAUTH_TOKEN')
  OAUTH_TOKEN_SECRET = ENV.fetch('FLICKR_OAUTH_TOKEN_SECRET')
  GROUP_ID = ENV.fetch('FLICKR_GROUP_ID')
  SCORE_TOPIC_URL = ENV.fetch('FLICKR_SCORE_TOPIC_URL')
